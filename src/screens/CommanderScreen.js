...
const s = StyleSheet.create({
  ...
  headerSub:      { fontFamily: FONT.MONO, fontSize: 9, color: C.TEXT_MUTED, letterSpacing: 2, textAlign: 'center', marginBottom: 18 },
  ...
  cardEmoji:      { width: 72, alignItems: 'center', justifyContent: 'center', paddingVertical: 18 },
  cmdEmoji:       { fontSize: 34 },
  cardBody:       { flex: 1, padding: 12 },
  cmdName:        { fontSize: 14, fontWeight: '900', color: C.TEXT, letterSpacing: 2 },
  rarityBadge:    { borderWidth: 1, paddingHorizontal: 5, paddingVertical: 1 },
  rarityText:     { fontFamily: FONT.MONO, fontSize: 7, letterSpacing: 1, fontWeight: '900' },
  levelText:      { fontFamily: FONT.MONO, fontSize: 9, color: C.AMBER, letterSpacing: 1 },
  ...
  rotationText:   { fontFamily: FONT.MONO, fontSize: 7, color: C.CYAN, letterSpacing: 1 },
  cmdDesc:        { fontSize: 11, color: C.TEXT_DIM, marginBottom: 5 },
  cmdTaunt:       { fontSize: 10, color: C.CYAN, fontStyle: 'italic', fontFamily: FONT.MONO },
  selectedBadge:  { position: 'absolute', top: 8, right: 8, width: 22, height: 22, alignItems: 'center', justifyContent: 'center' },
  selectedTick:   { color: '#000', fontWeight: '900', fontSize: 12 },
  lockBadge:      { position: 'absolute', top: 8, right: 8, width: 28, height: 28, alignItems: 'center', justifyContent: 'center' },
  ...
  abilityIcon:    { fontSize: 16 },
  abilityName:    { fontFamily: FONT.MONO, fontSize: 9, fontWeight: '900', color: '#FFB300', letterSpacing: 1.5 },
  abilityDesc:    { fontFamily: FONT.MONO, fontSize: 8, color: C.TEXT_MUTED, marginTop: 2 },
  ...
  diffBtn:        { flex: 1, backgroundColor: C.BG_CARD, borderWidth: 1, borderColor: C.BORDER, padding: 12, alignItems: 'center' },
  diffBtnActive:  { borderColor: C.CYAN, backgroundColor: C.CYAN_DIM },
  diffEmoji:      { fontSize: 20, marginBottom: 4 },
  diffLabel:      { fontSize: 11, fontWeight: '900', color: C.TEXT_DIM, letterSpacing: 1 },
  diffDesc:       { fontFamily: FONT.MONO, fontSize: 9, color: C.TEXT_MUTED, marginTop: 2 },

  btnRow:         { flexDirection: 'row', gap: 10, marginBottom: 8 },
  backBtn:        { flex: 1, backgroundColor: C.BG_CARD, borderWidth: 1, borderColor: C.BORDER, padding: 16, alignItems: 'center' },
  backBtnText:    { fontFamily: FONT.MONO, fontSize: 12, color: C.TEXT_DIM, letterSpacing: 2 },
  battleBtn:      { flex: 2, borderWidth: 1, borderColor: C.CYAN, padding: 16, alignItems: 'center', overflow: 'hidden', position: 'relative' },
  battleBtnOff:   { borderColor: C.BORDER },
  battleBtnText:  { fontSize: 13, fontWeight: '900', color: C.CYAN, letterSpacing: 2 },
});
