...
const s = StyleSheet.create({
  ...
  turnBadge:    { backgroundColor: C.CYAN_DIM, borderWidth: 1, borderColor: C.CYAN, paddingHorizontal: 12, paddingVertical: 6, flexDirection: 'row', alignItems: 'center', gap: 5 },
  ...
  turnText:     { fontFamily: FONT.MONO, fontSize: 10, color: C.TEXT, letterSpacing: 1 },
  ...
  intel:        { borderWidth: 1, borderColor: C.BORDER, backgroundColor: C.BG_CARD, marginBottom: 12, minHeight: 94 },
  ...
  intelCmd:     { fontSize: 14 },
  intelText:    { fontSize: 13, color: C.TEXT, padding: 12, paddingBottom: 6, fontWeight: '500', lineHeight: 19 },
  intelReaction:{ fontFamily: FONT.MONO, fontSize: 11, color: C.CYAN, paddingHorizontal: 12, paddingBottom: 10, fontStyle: 'italic' },
  ...
  voiceBtn:     { flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderColor: C.CYAN, paddingVertical: 11, paddingHorizontal: 26, backgroundColor: C.CYAN_DIM },
  voiceBtnActive:{ borderColor: C.RED, backgroundColor: C.RED_DIM },
  voiceIcon:    { fontSize: 18 },
  voiceBtnText: { fontFamily: FONT.MONO, fontSize: 12, color: C.CYAN, letterSpacing: 2 },
  voiceError:   { fontFamily: FONT.MONO, fontSize: 10, color: C.RED, marginTop: 6, textAlign: 'center', paddingHorizontal: 20 },
